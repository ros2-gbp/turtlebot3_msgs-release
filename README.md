## turtlebot3_msgs (kilted) - 2.4.0-1

The packages in the `turtlebot3_msgs` repository were released into the `kilted` distro by running `/usr/bin/bloom-release turtlebot3_msgs -t kilted -r kilted --edit` on `Mon, 14 Jul 2025 07:12:00 -0000`
...
## turtlebot3_msgs (rolling) - 2.4.0-1
